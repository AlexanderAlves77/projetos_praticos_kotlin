package br.com.fulldevstack.rest_spring_boot_kotlin.unittest.mapper
...
class DozerMapperTest {
    ...
    fun parseEntityToVOTest() {
        val output: PersonVO = DozerMapper.parseObject(inputObject!!.mockEntity(),
            PersonVO::class.java)
    ...
    fun parseEntityListToVOListTest() {
        val outputList: ArrayList<PersonVO> =
            DozerMapper.parseListObjects(inputObject!!.mockEntityList(),
                PersonVO::class.java)
    ...
    fun parseVOToEntityTest() {
        ...
        val output: Person = DozerMapper.parseObject(inputObject!!.mockVO(),
            Person::class.java)
